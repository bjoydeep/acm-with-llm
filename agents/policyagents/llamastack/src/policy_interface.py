...
st.markdown(
    """
    <h1 style="margin:0; font-size:2.5rem;">ACM Policy Demo</h1>
...
with left_col:
    ...
    instruct=(
            "You are an expert at writing GRC (governance risk and compliance) Policies"
